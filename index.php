    ...
    <section class="slide slide-one">
      <div class="container">
        <div class="banner-text">
          <h4>Curated Style for </h4>
          <h3>the Modern Woman<br>
            </h3>
            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 color-2 ">
                            <div>
                            <h4 class=" ">Our expertise</h4>
                            <p class="para ">Our specialization facility Women will often lose fat first from upper body sites, 
                              such as the arms. Lower body sites, such as the hips and thighs, can often take longer to lose fat. 
                              This pattern reverses in women who are pregnant or lactating. The body will preferentially tap into 
                              lower body fat stores first.</p>
